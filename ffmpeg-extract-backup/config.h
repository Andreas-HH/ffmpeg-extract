...
#define FFMPEG_CONFIGURATION "--enable-libmp3lame --enable-gpl --enable-libvorbis --enable-pthreads --enable-libxvid --enable-x11grab --enable-libx264 --enable-libtheora --enable-nonfree --disable-stripping --enable-avfilter --enable-version3 --enable-debug=3"
...
#define CONFIG_X11_GRAB_DEVICE_INDEV 1
