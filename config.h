...
#define FFMPEG_CONFIGURATION "--enable-libmp3lame --enable-gpl --enable-libvorbis --enable-pthreads --enable-x11grab --enable-libx264 --enable-libtheora --enable-nonfree --disable-stripping --enable-avfilter --enable-version3"
